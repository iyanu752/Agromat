...
const handleSave = async () => {
  ...
  if (userId) {
    try {
      const updatedProfile = await updateVendorProfile(userId, profileData)
...
const updateVendorProfile = async (id: string, updatedProfile: VendorProfileType) => {
  try {
      ...
      <header className="border-b border-gray-200">
        <div className="container mx-auto flex items-center justify-between px-4 py-4">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold tracking-tight">Vendor Profile</h1>
          </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      ...
                      <p className="rounded-md border border-gray-200 px-3 py-2">
                        {profileData.businessPhoneNumber || "N/A"}
                      </p>
                    )}
                  </div>
